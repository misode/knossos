...
const downloadData = ref({
  labels: ['2022-01-10', '2022-01-11', '2022-01-12', '2022-01-13', '2022-01-14', '2022-01-15', '2022-01-16', '2022-01-17', '2022-01-18', '2022-01-19', '2022-01-20', '2022-01-21', '2022-01-22', '2022-01-23', '2022-01-24', '2022-01-25'],
  data: [
    {
      title: 'Downloads',
      color: 0x00af5c,
...
<template>
  <Card class="data-card">
    <div class="tabs">
      <div class="data-point button-base" :class="{'selected': selectedDataType === 'downloads'}" @click="select('downloads')">
      ...
      <div class="data-point button-base" :class="{'selected': selectedDataType === 'pageViews'}" @click="select('pageViews')">
        <div class="data-point__title">
          Total page views
        </div>
        <div class="data-point__value">
      ...
      <div class="data-point button-base" :class="{'selected': selectedDataType === 'revenue'}" @click="select('revenue')">
        <div class="data-point__title">
          Total revenue
        </div>
        <div class="data-point__value">
      ...
      <div class="data-point button-base" :class="{'selected': selectedDataType === 'followers'}" @click="select('followers')">
        <div class="data-point__title">
          Total followers
        </div>
        <div class="data-point__value">

<template>
  <div>
    ...
    <Card class="ratio-data">
      <div class="title">
        Download : Page view revenue ratio
      </div>
      <div class="data">
    ...
    <Card class="revenue-card">
      ...
      <div class="table revenue">
        ...
        <div class="table-row" v-for="item in historyData">
          <div class="table-cell">
            <Checkbox v-model="item.showing" :label="dayjs(item.date).format('MMMM D, YYYY')" :collapsingToggleStyle="true"/>
          </div>
          <div class="table-cell">
    ...
    <Card class="transaction-card">
      ...
      <div class="table transactions">
        ...
        <div
          ...
          class="table-row"
        >
          <div class="table-cell">{{ $dayjs(payout.created).format('MMMM D, YYYY [at] h:mm A') }}</div>
